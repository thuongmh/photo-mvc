...
class Helper
{
    ...
    static function oldInputResgister($username, $password, $repassword, $email, $firstname, $lastname)
    {
        self::setInput('old_username', $username);
        self::setInput('old_password', $password);
        self::setInput('old_confirm', $repassword);
        self::setInput('old_email', $email);
        self::setInput('old_firstname', $firstname);
        self::setInput('old_lastname', $lastname);
    }

    static function oldInputReset($email)
    {
        self::setInput('old_email', $email);
    }
    ...
    static function loadView ($view, $param = array())
    {
        extract($param);
